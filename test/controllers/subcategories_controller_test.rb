...
class SubcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subcategory" do
    assert_difference('Subcategory.count') do
      post subcategories_url, params: { subcategory: { category_id: @subcategory.category_id, description: @subcategory.description, name: @subcategory.name } }, as: :json
    end
  ...
  test "should update subcategory" do
    patch subcategory_url(@subcategory), params: { subcategory: { category_id: @subcategory.category_id, description: @subcategory.description, name: @subcategory.name } }, as: :json
    assert_response 200
  end
